...
import CatalogusInhoud from "./CatalogusInhoud";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "catalogus" });
  return {
    title: t("titel"),
    description: t("metaBeschrijving"),
    alternates: paginaAlternates(locale, "/catalogus"),
  };
}
